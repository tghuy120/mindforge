---
title: GSD 项目规模分级实践——从快速脚本到超大规模的 Context 策略演进
created: 2026-03-28
tags:
  - vibe-coding
  - GSD
...
# GSD 项目规模分级实践——从快速脚本到超大规模的 Context 策略演进
...
**GSD 的 L4 局限性**（来自[[Vibe-Coding大项目落地困局——从Context爆炸到Skill Runtime的范式迁移]]的分析）：
...
- [[Vibe-Coding大项目落地困局——从Context爆炸到Skill Runtime的范式迁移]]——四层架构与 Granularity Layer
- [[架构师视角的AI Harness Engineering最佳实践]]——State Layer 与 Harness Engineering
- [[Vibe Coding流程框架选择指南：GSD、SpecKit、OpenSpec与Superpowers的组合实践]]——GSD 与其他框架的组合实践
